...
namespace SmartMonitoring.Server.Migrations
{
    ...
    [Migration("20231104232917_WikiAddMigration")]
    partial class WikiAddMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartMonitoring.Server.Entities.WikiEntity", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SmartMonitoring.Server.Entities.WikiSolutionEntity", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SmartMonitoring.Server.Entities.WikiSolutionEntity", b =>
                {
                    ...
                    b.HasOne("SmartMonitoring.Server.Entities.WikiEntity", "Wiki")
                        .WithMany("WikiSolutions")
